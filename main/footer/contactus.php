...
<body>
    ...
    <div class="content">
        <h2 class="center title2"> Contact Us </h2>
        <p class="center"> Are you having any trouble? </p>
        <p class="center"> Please reach out to email : <a href = "mailto: pap1714vacariucalex@gmail.com">pap1714vacariucalex@gmail.com<a> </p>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $.getJSON("http://localhost/Zusammen/translations/<?php echo $_SESSION['nativeLanguage']; ?>.json", function(json) {
            ...
            //body
            $('.center:eq(0) ').html(json.contact.text1);
            $('.center:eq(1) ').html(json.contact.text2);
            $('.center:eq(2) ').html(json.contact.text3);
        });
    });
</script>
</html>
